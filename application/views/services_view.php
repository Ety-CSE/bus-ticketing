    ...
    <div class="row">
      ...
      <div class="content-header col-12 col-lg-8 col-md-8 col-sm-10">
          <h2 class="text-center hidden-xs-down"> 
            <span>Find a rent-a-Car</span> – Search, Compare & Save
       </h2>
          ...
          <p class="">Compare 900 companies at over 60,000 locations. Price Match Guarantee</p>
    ...
    <div class="row">
      ...
      <div class="col-12 col-lg-4 col-md-4 col-sm-6">
        ...
        <div class="row">
          <?php 
          if ($service->s_photo) {
             $imgs = explode(',', $service->s_photo);
             $img = array_filter($imgs,'strlen');
              // dump($img);
             $output = '';
             foreach ($img as $img) {
              $output .= '<a href="'.site_url("upload").'/'.$this->service_m->media_by_id($img).'?image=251" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-4"> <img src="'.site_url("upload").'/'.$this->service_m->media_by_id($img).'?image=251" class="img-fluid"> </a>';            

             }
              echo $output;
           } else {
                echo '<a href="'.site_url("images/").'services.jpg?image=251" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-4">
                    <img src="'.site_url("images/").'services.jpg?image=251" class="img-fluid">
                </a>';
           }
         ?>
        </div>
      ...
      <div class="col-12 col-lg-4 col-md-4 col-sm-6">
        <div class="row contact-view"  style="display: none">
          <div class=" col-12">
        ...
        <div class="row ">
          ...
          ?>
              <button id="Login" class="btn btn-outline-success  btn-block btn-contact">
                Contact
              </button> 
          <?php
            } else {
               if($service->seller_id){
          ?>
              <button id="order-contact" class="btn btn-outline-success  btn-block btn-contact">
                Contact
              </button> 
          <?php 
              }
        ...
        <div class="col-0 col-lg-2 col-md-2 col-sm-0"></div>
      </div>
      </div>
...
<div class="row services">
  <div class="container">
    <div class="row">
      ...
      $loop .='        <img src='. site_url("upload/".$this->service_m->media_by_id($img[0])).' alt="" class="img-fluid">';
      } else {
      $loop .='        <img src='. site_url("images/services.jpg").' alt="" class="img-fluid">';
      }
    ...
    $("#Login").on( 'click', function () {
        ...
        if(!alertify.errorAlert){
          ...
          alertify.dialog('errorAlert',function factory(){
            return{
                    build:function(){
                        var errorHeader = '<span class="la la-lock la-2x" '
