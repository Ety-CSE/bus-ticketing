    ...
    <?php  echo $message = (validation_errors()) ? '<div class="alert alert-danger" role="alert">'.validation_errors().'</div>' : '' ; ?>
        <?php echo form_open(); ?>
          ...
          <div class="form-group row">
            <label for="order_id" class="col-sm-2 col-form-label">Req. ID</label>
            <div class="col-sm-10">
          ...
          <div class="form-group row">
    	      ...
    	      <div class="col-sm-10">
    		      <?php
                  echo form_dropdown('offer_id', $this->order_m->offer_dw(),$order->offer_id,' class="form-control"  required="required" id="offer_id" ');
    		      ?>
    	      </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-2">
              <?php
                  echo form_dropdown('seat', array('2','4','6','7'),$car_info['seat'],'class="form-control"  required="required" id="seat" ');
                ?>
            </div>                            
          </div>
          <!-- Fuel -->
          <div class="form-group row">
            ...
            <div class="col-sm-4">
              <?php 
                ...
                ),$offer->rentacar,'class="form-control"  required="required" id="gas" ');
              ?>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
             <?php
                  echo form_textarea( array('name'=>'details','value'=>set_value('details', $custome_offer['details']),'rows'=> '3', 'cols'=> '10', 'style' => 'width:100%', 'class'=>'form-control'));
            ...
            <div class="col-lg-4 package">
              <div class="form-group row">
                ...
                <div class="col-sm-12">
                  <div class="input-group">
                    <?php
                      echo form_input('rent',$order->rent,'class=" custom-checkbox form-control aria-label="Amount" placeholder="Amount"');
                    ?>
                    <!-- <input type="text" class="form-control" aria-label="Amount"> -->
                    <div class="input-group-append">
                      <span class="input-group-text">TK</span>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-4">
             <?php
                  echo form_input('p_add', set_value('p_add', $pickup_info['p_add']), 'class="form-control" placeholder="Services Charge" id="p_add"');
            ...
            <label for="d_add" class="col-sm-2 col-form-label">Drop Address</label>                
            <div class="col-sm-4">
              <div class="input-group">
                <?php
                  echo form_input('d_add', set_value('d_add', $destination['d_add']), 'class="form-control" placeholder="Services Charge" id="d_add"');
                  // echo form_textarea( array('name'=>'description','value'=>set_value('description', $order->description),'rows'=> '2', 'cols'=> '10', 'style' => 'width:100%', 'class'=>'form-control'));
                 ?>
