<div class="container">
  <div class="row">
    <div class="content-header col-12">
      <?php echo anchor('admin/user/edit', '<i class="la la-user-plus"></i> Add an Admin', 'class="btn btn-success btn-md"'); ?>
      <h2 class="content-title"><i class="fa fa-users fa-2x">  </i> Admin Users List</h2>
    </div>
    
    <!-- <h2>User List</h2> -->

    <div class="col-12">
      <table class="table table-bordered table-striped table-condensed flip-content" id="table" style="background: #fff;">
