<div class="container">
  <div class="row">
      ...
      <h2 class="content-title"><i class="fa fa-users fa-2x">  </i> Agent List</h2>
    </div>
    <?php echo anchor('admin/user/edit', '<i class="la la-user-plus"></i> Add an Agent', 'class="btn btn-success btn-md"'); ?>
  <!-- <h2>User List</h2> -->
