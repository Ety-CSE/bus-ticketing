<div class="container">
  <div class="row">
    <div class="content-header col-12">
      <?php echo anchor('admin/user/edit', '<i class="la la-user-plus"></i> Add a Driver', 'class="btn btn-success btn-md"'); ?>
      <h2 class="content-title"><i class="fa fa-users fa-2x">  </i> Driver List</h2>
    </div>
