        ...
        <?php echo form_open('', 'class="kt-form kt-form--label-right"'); ?>
          <div class="kt-portlet__body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">             
                <?php
                    echo form_dropdown('type', array('0'=>'Please Select', '1'=>'Admin','2'=>'Owner', '3'=>'Customer', '4'=>'Driver', '5'=>'Customer Care'),$user->type,'aria-describedby="sub-cat" class="form-control lineAwsome" placeholder="" id="type"' );
                ?>
              </div>
            </div>
            <div class="form-group row">
