<div class="container">
  <div class="row  content-header">
    ...
    <div class="col-lg-6 offset-lg-1 ">
      <h2 class="content-title"> <?php echo empty($buyer_request->id) ? '<i class="far fa-fw fa-car">  </i> Request for a car ': 'Edit buyer_request <i class="far fa-fw fa-user-check">  </i> '.$buyer_request->buyer_request; ?></h2>
      <hr>
      <br>
    <?php  echo $message = (validation_errors()) ? '<div class="alert alert-danger" role="alert">'.validation_errors().'</div>' : '' ; ?>
        ...
        ?>
          ...
          <!-- customer -->
          <input type="hidden" name="customer" value="<?php echo $this->session->userdata('id');?>">
          <!-- <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <?php
                  echo form_dropdown('status', array('Active', 'Dactive', 'Cancle', 'Orderd'),$buyer_request->status,'aria-describedby="sub-cat" class="form-control lineAwsome" placeholder="buyer_request Sub-buyer_request" id="status"' );
              ?>
            </div>
          </div>
          ...
          <hr>
    	    <div class="form-group row">
              ...
              <?php echo empty($buyer_request->id) ? form_submit('submit', 'Save', 'class="btn btn-warning float-right"') : form_submit('submit', 'Update', 'class="btn btn-warning pull-right"');?>
    	      </div>
    	    </div>
