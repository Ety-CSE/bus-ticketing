<div class="container" style="margin-top:0px">
  <div class="row">
    ...
    <div class="col-md-2 cancel_warapper">
      ...
      <a href="#" id="Cancel_btton" class="btn btn-block btn-outline-warning align-text-bottom" style="margin-top:25px">Cancel Booking</a>
      <?php else:?>
      <a href="#" class="btn btn-block btn-link text-danger" style="margin-top:25px">Booking Canceled</a>
      <?php endif;?>
    </div>
...
<script>
  $(document).ready(function(){
    ...
    $('#Cancel_btton').click(function(){
      event.preventDefault();
      // alert('clicked');
      var url = '<?php echo site_url('admin/customer/cancel_trip/'.$booking->id); ?>';
