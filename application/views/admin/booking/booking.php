      ...
      <table class="table">
        ...
        <?php if($booking): 
          ...
          <tr>
            ...
            <td><?php echo $this->user_m->user_by_id($b->user_id);?></td>
            <td class="<?php echo $ststus = ($b->status != 0?'text-danger': 'text-success');?>"><?php echo $this->booking_m->booking_status($b->status);?> </td>
            <td><?php echo bt_view('admin/booking/ticket/'.$b->id); ?></td>
