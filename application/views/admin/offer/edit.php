...
<div class="container">
  <div class="row">
    <div class="content-header col-12">
      <h2 class="content-title"> <?php echo empty($offer->id) ? 'Add a <i class="la la-cart-plus  la-2x">  </i> New offer' : 'Edit offer <i class="la la-cart-plus  la-2x">  </i> '.$offer->offer; ?></h2>
      <?php// dump($offer);?>
    </div>
    ...
    <?php  echo $message = (validation_errors()) ? '<div class="alert alert-danger" role="alert">'.validation_errors().'</div>' : '' ; ?>
        ...
        <!-- title -->
          ...
          <!-- rent a car -->
    	    <div class="form-group row">
    	      <label for="inputEmail3" class="col-sm-2 col-form-label">RentAcar</label>
    	      <div class="col-sm-10">
    		      <?php 
                echo form_dropdown('rentacar', $this->offer_m->rentacar_dw(),$offer->rentacar,' class="form-control"  required="required" id="rentacar" ');
    		      ?>
    	      </div>
    	    </div>
          <!-- car -->
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-10">
              <div class="container-fluid">
                <div class="row">
                  <!-- hourly -->
                  <div class="col-lg-4 package border-right">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                          <div class="input-group">
                            <div class="input-group-prepend">
                              <div class="input-group-text">
                                <input type="checkbox" value="1" name="m_overtime" <?php echo ($month['m_overtime'] == '1') ? 'Checked' :'';?> aria-label="Checkbox for following text input">
                              </div>
                            </div>
                            <?php
          ...
          <hr>
    	    <div class="form-group row">
              ...
              <?php echo empty($offer->id) ? form_submit('submit', 'Save', 'class="btn btn-warning pull-right"') : form_submit('submit', 'Update', 'class="btn btn-warning pull-right"');?>
    	      </div>
    	    </div>
